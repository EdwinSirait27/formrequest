...
.dark .select2-dropdown {
   ...
   <div>
            ...
            <div>
                <label for="type" class="block text-sm font-semibold text-slate-300 mb-2 flex items-center space-x-2">
                    <svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                    </svg>
                ...
                <div class="relative">
                    <select id="type" name="type" required
                        ...
                        <option value="Vendor" class="bg-slate-800">Vendor</option>
                        <option value="Non Vendor" class="bg-slate-800">Non Vendor</option>
                    </select>
                    <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                        <svg class="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
...
<div class="px-4 pb-8">
    ...
    <div class="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-2xl p-4 mb-6">
        <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-amber-400 mb-1">Create Vendor</h3>
                <p class="text-xs text-slate-400 leading-relaxed">
                    Create the vendor information below. Fields marked with <span class="text-red-400">*</span> are required.
                </p>
            </div>
        </div>
    </div>
        <form method="POST" action="{{ route('storevendor') }}"class="space-y-5">
        @csrf
<div class="space-y-4">
            <div>
                <label for="vendor_name" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                 ...
                 <input type="text" id="vendor_name" name="vendor_name" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('vendor_name')}}" placeholder="Example: PT. Abadi" required>
                @error('vendor_name')
            ...
            <div>
                <label for="email" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                 ...
                 <input type="email" id="email" name="email"class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('email')}}"placeholder="Example: blabla@company.co.id">
                @error('email')
                    <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            ...
            <div>
                <label for="phone" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                 ...
                 <input type="number" id="phone" name="phone"class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('phone') }}"placeholder="08xxx">
                @error('phone')
                    <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            ...
            <div>
                <label for="address" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                 ...
                 <input type="text" id="address" name="address"class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('address') }}"placeholder="jl....">
                @error('address')
                    <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                 ...
                 <input type="text" id="city" name="city"class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('city') }}"placeholder="denpasar">
                    @error('city')
                        <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                ...
                <div>
                    ...
                    <input type="text" id="province" name="province"class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('province') }}"placeholder="Bali">
                    @error('province')
                        <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                 ...
                 <input type="number" id="postal_code" name="postal_code" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('postal_code') }}"placeholder="83...">
                    @error('postal_code')
                        <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
        ...
        <div class="space-y-4">
            ...
            <div>
                <label for="bank_name" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                 ...
                 <input type="text" id="bank_name" name="bank_name"class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('bank_name') }}" required placeholder="Mandiri">
                @error('bank_name')
                    <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />

...
.dark .select2-dropdown {
    ...
    <div class="px-4 space-y-6 pb-8">
        ...
        {{-- Form --}}
            ...
            {{-- Bank Account Name & Number (2 column) --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
            ...
            <div>
                ...
                <div class="relative">
                    <select id="transfer" name="transfer" required
                        ...
                        <option value="Direct"   class="bg-slate-800" {{ old('transfer', $vendor->transfer) == 'Direct' ? 'selected' : '' }}>Direct</option>

        ...
        <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-slate-400 leading-relaxed">
                    Update the vendor information below. Fields marked with <span class="text-red-400">*</span> are required.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                {{-- <input type="text" id="vendor_name" name="vendor_name" required
                    ...
                    value="{{ old('vendor_name', $vendor->vendor_name) }}"> --}}
                 <input type="text" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('vendor_name', $vendor->vendor_name) }}" required>
            ...
            <div>
                ...
                {{-- <input type="email" id="email" name="email"
                    ...
                    class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                           focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                    value="{{ old('email', $vendor->email) }}"> --}}
                 <input type="email" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('email', $vendor->email) }}">
            ...
            <div>
                ...
                {{-- <input type="text" id="phone" name="phone"
                    ...
                    class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                           focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                    value="{{ old('phone', $vendor->phone) }}"> --}}
                 <input type="number" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('phone', $vendor->phone) }}">
            ...
            <div>
                ...
                {{-- <input type="text" id="address" name="address"
                    ...
                    class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                           focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                    value="{{ old('address', $vendor->address) }}"> --}}
                 <input type="text" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('address', $vendor->address) }}">
                ...
                <div>
                    ...
                    {{-- <input type="text" id="city" name="city"
                        ...
                        class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                               focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        value="{{ old('city', $vendor->city) }}"> --}}
                 <input type="text" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('city', $vendor->city) }}">
                ...
                <div>
                    ...
                    {{-- <input type="text" id="province" name="province"
                        ...
                        class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                               focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        value="{{ old('province', $vendor->province) }}"> --}}
                 <input type="text" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('province', $vendor->province) }}">
                ...
                <div>
                    ...
                    {{-- <input type="text" id="postal_code" name="postal_code"
                        ...
                        class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                               focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        value="{{ old('postal_code', $vendor->postal_code) }}"> --}}
                 <input type="number" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('postal_code', $vendor->postal_code) }}">
                ...
                <div>
                    ...
                    {{-- <input type="text" id="npwp" name="npwp" required
                        ...
                        class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                               focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        value="{{ old('npwp', $vendor->npwp) }}"> --}}
                 <input type="number" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('npwp', $vendor->npwp) }}" required>
                    @error('npwp')
                        <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                            <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
            ...
            <div>
                ...
                {{-- <input type="text" id="bank_name" name="bank_name" required
                    ...
                    class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                           focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                    value="{{ old('bank_name', $vendor->bank_name) }}"> --}}
                 <input type="text" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('bank_name', $vendor->bank_name) }}" required>
                ...
                <div>
                    ...
                    {{-- <input type="text" id="bank_account_name" name="bank_account_name" required
                        ...
                        class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                               focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        value="{{ old('bank_account_name', $vendor->bank_account_name) }}"> --}}
                 <input type="text" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('bank_account_name', $vendor->bank_account_name) }}" required>
                ...
                <div>
                    ...
                    {{-- <input type="text" id="bank_account_number" name="bank_account_number" required
                        ...
                        class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500
                               focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
                        value="{{ old('bank_account_number', $vendor->bank_account_number) }}"> --}}
                 <input type="number" class="form-input w-full px-4 py-3 rounded-xl"value="{{ old('bank_account_number', $vendor->bank_account_number) }}" required>

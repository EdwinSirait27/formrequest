...
@endif
 ...
 <div>
    ...
    @if (optional($request->approval)->approver2_at)
        ...
        <br>
    @endif
    @if (!empty($request->approval?->prApprover?->employee?->employee_name))
        <div>
            <label for="ca_number" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                <svg class="w-4 h-4 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
            ...
            <input type="text" id="pr_approver" name="pr_approver" class="form-input w-full px-4 py-3 rounded-xl"
                value="{{ old('pr_approver', optional($request->approval->prApprover->employee)->employee_name) }}" disabled>
        ...
        <br>
    @endif
    @if (optional($request->approval)->pr_approver_at)
        <div>
            <label for="ca_number" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                <svg class="w-4 h-4 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
            ...
            <input type="text" id="pr_approver_at" name="pr_approver_at" class="form-input w-full px-4 py-3 rounded-xl"
                value="{{ old('pr_approver_at', optional($request->approval)->pr_approver_at) }}" disabled>

            @error('pr_approver_at')
                <p class="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                    <svg class="w-3.5 h-3.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
        ...
        <br>
    @endif
                               @if (!empty($request->notes_ga))

            <div>
                <label for="notes_ga" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                    <svg class="w-4 h-4 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                ...
                <textarea id="notes_ga" name="notes_ga" class="form-input w-full px-4 py-3 rounded-xl"
                    placeholder="notes from ga" rows="4"disabled>{{ old('notes_ga', $request->notes_ga) }}</textarea>

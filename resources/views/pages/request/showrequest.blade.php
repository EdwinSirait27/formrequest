...
@section('content')
    ...
    @endif
    {{-- @if (optional($request->approval->approver1User->employee)->employee_name) --}}
    @if (!empty($request->approval?->approver1User?->employee?->employee_name))
        ...
        <br>
    @endif
    {{-- @if (optional($request->approval)->approver1_at) --}}
    @if (!empty($request->approval?->approver1_at))
        ...
        <br>
    @endif
    {{-- @if (optional($request->approval->approver2User->employee)->employee_name) --}}

    ...
    <div class="px-4 pb-8">
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Show the request form information below..
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="assets_wrapper">
            ...
            <div>
                ...
                <select id="assets" name="assets" class="select2 w-full sm:w-40 px-3 py-2 border rounded-lg text-sm"
                    disabled>
                ...
                @foreach ($links as $i => $link)
                    <div class="flex gap-2 link-row">
                        <input type="text" name="links[{{ $i }}][link]"
                            ...
                            placeholder="link referal product or link product photo" disabled>
                    </div>
                @endforeach
            @else
                <div class="flex gap-2 link-row">
    ...
    @if (auth()->user()->hasRole('finance') && optional($request->requesttype)->code == 'CA')
        <div>
            ...
            <input type="text" id="ca_number" name="ca_number" class="form-input w-full px-4 py-3 rounded-xl"
                value="{{ old('ca_number', optional($request)->ca_number) }}" disabled>
    ...
    <tr>
        <td class="p-2">
            <input type="text" 
                ...
                class="w-full form-input rounded-lg px-2 py-1" placeholder="item name" disabled>
        </td>
        <td class="p-2">
            <input type="text" 
                name="items[${index}][specification]" 
                value="${item?.specification ?? ''}"
                class="w-full form-input rounded-lg px-2 py-1"placeholder="specification" disabled>
        </td>
        <td class="p-2">
            <input type="text" 
        ...
        <td class="p-2">
            <select name="items[${index}][uom]" 
                class="select2-uom w-full form-input rounded-lg px-2 py-1" disabled>
                ${uomOptions}
            </select>
        </td>
        <td class="p-2">
            <input type="text" 
                ...
                value="${item?.price ?? ''}"
                class="price w-full form-input rounded-lg px-2 py-1" placeholder="price" disabled>
        </td>
        <td class="p-2">
            <input type="text" 
    ...
    <tr>
        ...
        <td class="p-2">
            <input type="text" 
                name="items[${index}][qty]" 
                value="${item?.qty ?? ''}"
                class="qty w-full form-input rounded-lg px-2 py-1" placeholder="qty" disabled>
        </td>
        <td class="p-2">
            <select name="items[${index}][uom]" 
                class="select2-uom w-full form-input rounded-lg px-2 py-1" disabled>
        ...
        <div class="flex items-start gap-2">
            ...
            <div class="flex-1">
                <select name="items[${index}][vendors][${i}][vendor_id]" 
                    class="select2-vendor w-full rounded-lg px-2 py-1" disabled>
    ...
    <script>
        ...
        <div class="flex gap-2 link-row">
            <input type="text" 
                ...
                class="form-input w-full px-4 py-3 rounded-xl"
                placeholder="link product or link photo product" disabled>
            </div>
    `;
        ...
        <div class="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-2xl p-4 mb-6">
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    <h3 class="text-sm font-semibold text-amber-400 mb-1">Show Request Form</h3>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Show the request form information below. Fields marked with <span class="text-red-400">*</span>
                        are required.
                    </p>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <select name="company_id"
                        id="company_id"class="select2 w-full sm:w-40 px-3 py-2 border rounded-lg text-sm"{{ $isDirector ? 'disabled' : '' }} disabled>
                        @foreach ($companies as $id => $name)
                            <option value="{{ $id }}"
                                {{ old('company_id', $request->company_id) == $id ? 'selected' : '' }}>
                                {{ $name }}
...
@endif
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="title" name="title" class="form-input w-full px-4 py-3 rounded-xl"
                        value="{{ old('title', $request->title) }}" placeholder="butuh segera untuk bla bla bla" disabled {{ $isDirector ? 'disabled' : '' }}>
                         @if($isDirector)
...
@endif
                ...
                <div id="vendor_wrapper">
                    <div>
                        ...
                        <select id="vendor_id" name="vendor_id"
                            class="select2 w-full sm:w-40 px-3 py-2 border rounded-lg text-sm" {{ $isDirector ? 'disabled' : '' }}disabled>
                            <option value="">Choose Vendor</option>
                            @foreach ($vendors as $id => $name)
                                <option value="{{ $id }}"
                                    {{ old('vendor_id', $request->vendor_id) == $id ? 'selected' : '' }}>
...
@endif
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" id="request_date" name="request_date"
                        class="form-input w-full px-4 py-3 rounded-xl"
                        value="{{ old('request_date', optional($request->request_date)->format('Y-m-d')) }}" disabled{{ $isDirector ? 'disabled' : '' }}>
                         @if($isDirector)
...
@endif
                ...
                <div>
                    ...
                    <input type="date" id="deadline" name="deadline" class="form-input w-full px-4 py-3 rounded-xl"
                        value="{{ old('deadline', optional($request->deadline)->format('Y-m-d')) }}" disabled {{ $isDirector ? 'disabled' : '' }}>
                         @if($isDirector)
...
<br>
            <div>
                ...
                <textarea id="notes" name="notes" class="form-input w-full px-4 py-3 rounded-xl"
                    placeholder="butuh segera untuk bla bla bla" rows="4" disabled {{ $isDirector ? 'disabled' : '' }}>{{ old('notes', $request->notes) }} </textarea>
                     @if($isDirector)
    <input type="hidden" name="deadline"
...
@endif
 ...
 <div>
    ...
    @endif
            ...
            <div>
                ...
                <textarea id="notes_dir" name="notes_dir" class="form-input w-full px-4 py-3 rounded-xl"
                    placeholder="notes from directors" rows="4"disabled>{{ old('notes_dir', $request->notes_dir) }}</textarea>
            ...
            <div>
                ...
                <select id="status" name="status" class="select2 w-full sm:w-40 px-3 py-2 border rounded-lg text-sm"disabled>
                    <option value="">Choose Status</option>
                    @foreach ($statuses as $key => $label)
                        <option value="{{ $key }}"
    ...
    <tr>
        <td class="p-2">
            <input type="text" 
                name="items[${index}][item_name]" 
                value="${item?.item_name ?? ''}"
                class="w-full form-input rounded-lg px-2 py-1" placeholder="item name" disabled ${isDirector ? 'disabled' : ''}>
                 ${isDirector ? `
        <input type="hidden" 
            name="items[${index}][item_name]" 
            value="${item?.item_name ?? ''}">
    ` : ''}
        ...
        <td class="p-2">
            <input type="text" 
                name="items[${index}][specification]" 
                value="${item?.specification ?? ''}"
                class="w-full form-input rounded-lg px-2 py-1"placeholder="specification" disabled ${isDirector ? 'disabled' : ''}>
                  ${isDirector ? `
        <input type="hidden" 
            name="items[${index}][specification]" 
            value="${item?.specification ?? ''}">
    ` : ''}
        ...
        <td class="p-2">
            <input type="text" 
                name="items[${index}][qty]" 
                value="${item?.qty ?? ''}"
                class="qty w-full form-input rounded-lg px-2 py-1" disabled ${isDirector ? 'disabled' : ''}>
                      ${isDirector ? `
        <input type="hidden" 
            name="items[${index}][qty]" 
            value="${item?.qty ?? ''}">
    ` : ''}
        ...
        <td class="p-2">
            <select name="items[${index}][uom]" 
                class="select2-uom w-full form-input rounded-lg px-2 py-1" disabled ${isDirector ? 'disabled' : ''}>
                ${uomOptions}
            </select>
             ${isDirector ? `
        <input type="hidden" 
    ...
    ` : ''}
        ...
        <td class="p-2">
            <input type="text" 
                name="items[${index}][price]" 
                value="${item?.price ?? ''}"
                class="price w-full form-input rounded-lg px-2 py-1" placeholder="price "disabled ${isDirector ? 'disabled' : ''}>
        ${isDirector ? `
        <input type="hidden" 
            name="items[${index}][price]" 
            value="${item?.price ?? ''}">
    ...
    <tr>
        <td class="p-2">
            <input type="text" 
                name="items[${index}][item_name]" 
                value="${item?.item_name ?? ''}"
                class="w-full form-input rounded-lg px-2 py-1" placeholder="item name" disabled ${disabledAttr}>
                   ${isDirector ? `
        <input type="hidden" 
            name="items[${index}][item_name]" 
            value="${item?.item_name ?? ''}">
    ` : ''}
        ...
        <td class="p-2">
            <input type="text" 
                name="items[${index}][qty]" 
                value="${item?.qty ?? ''}"
                class="qty w-full form-input rounded-lg px-2 py-1" placeholder="qty"disabled ${disabledAttr}>
                   ${isDirector ? `
        <input type="hidden" 
            name="items[${index}][qty]" 
            value="${item?.qty ?? ''}">

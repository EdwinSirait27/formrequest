...
@endforeach
    ...
    @endforeach
            ...
            {{-- <div class="mt-6">
                <h3 class="text-sm font-semibold text-slate-300 mb-3">Request Items <span class="text-red-400">*</span></h3>
 ...
 {{-- <div>
                    <label for="link" class="flex items-center gap-2 text-sm font-semibold text-slate-300 mb-2">
                        <svg class="w-4 h-4 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                    Link Reference or Link attachments
                    </label>
                    <input type="link" id="link" name="link"class="form-input w-full px-4 py-3 rounded-xl"
...
$('#add-row').click(function () {
    ...
    // Init Select2 hanya untuk UOM di row baru
    $('.select2-uom').select2({
        placeholder: "Choose",
        allowClear: true,
        width: '100%'

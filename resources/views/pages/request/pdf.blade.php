...
<div class="page">
    ...
    <table style="margin-bottom:8px;">
        ...
        <tr>
            <td rowspan="3" class="center" style="vertical-align:middle; padding:6px;">
                @if ($logoBase64)
                    <img src="{{ $logoBase64 }}" alt="Company Logo" style="max-height:100px; max-width:100%; object-fit:contain;">
                @endif
            </td>
    ...
    <table style="margin-bottom:8px; border-collapse:collapse;">
        ...
        <tr>
            ...
            <td class="info-td">:</td>
            <td class="info-td">{{ $request->vendor->transfer }}</td>
    ...
    <table style="margin-bottom:8px; border-collapse:collapse;">
        ...
        <tr>
            <td class="info-td" style="vertical-align:top; padding-top:3px;">Notes</td>
            <td class="info-td" style="vertical-align:top; padding-top:3px;">:</td>
            <td class="info-td" style="min-height:20px;">{{ $request->notes }}</td>
        </tr>
    </table>
    ...
    <table style="margin-bottom:6px;">
        ...
        <tr>
            ...
            <td class="center bold" style="font-size:8.5px; padding:4px;">Approve III</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="center" style="font-size:8.5px; padding:3px;"> {{ $managerName ?? 'Manager Dept. / OM' }}</td>
        ...
        <tr>
            ...
            <td class="center" style="font-size:8.5px; padding:3px;">{{$positionName}}</td>
            <td class="center" style="font-size:8.5px; padding:3px;">FAT</td>
            <td class="center" style="font-size:8.5px; padding:3px;">Direktur</td>
        </tr>
    </table>
    <table style="margin-bottom:6px;">
        <tr>

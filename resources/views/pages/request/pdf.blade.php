                ...
                <td style="width:48%; padding-right:16px;">
                    <table class="info-block">
                        ...
                        <tr>
                            ...
                            <td class="col">:</td>
                            <td class="val">{{ $request->store->name }}</td>
                        </tr>
                         @endif
                        @endisset
                    </table>
...
<table class="approval-table">
    <tr>
        <td class="ap-head">Request by</td>
        <td class="ap-head">Approver I (GA)</td>
        <td class="ap-head">Approver II (Director)</td>
    </tr>
    <tr>
        <td class="ap-sign">
            @if ($signatureBase64)
        ...
        <td class="ap-sign">
            @if ($showGASignature && $prApproverSignatureBase64)
                <img src="{{ $prApproverSignatureBase64 }}" style="max-height:54px; max-width:88%;">
            @endif
        </td>
        <td class="ap-sign">
            @if ($signatories['approver2']['signature'])
    ...
    <tr>
        <td class="ap-name">{{ optional($request->user->employee)->employee_name }}</td>
        <td class="ap-name">{{ $prApproverName ?? 'GA Approver' }}</td>
        <td class="ap-name">{{ $signatories['approver2']['name'] ?? 'Director' }}</td>
    </tr>
    <tr>
        <td class="ap-pos">{{ optional($request->user->employee->position)->name }}</td>
        <td class="ap-pos">{{ $prApproverPosition ?? 'General Affair' }}</td>
        <td class="ap-pos">{{ $signatories['approver2']['position'] ?? 'Director' }}</td>
    </tr>
    @if ($showGASignature && $prApproverAt)
    <tr>
        <td class="ap-pos"></td>
        <td class="ap-pos" style="font-size:7pt; color:#666;">{{ $prApproverAt }}</td>
        <td class="ap-pos"></td>
    </tr>
    @endif
</table>
                ...
                <table class="approval-table">
                    ...
                    <tr>
                        ...
                        <td class="ap-sign">
                            @if ($signatories['approver2']['signature'])
                                <img src="{{ $signatories['approver2']['signature'] }}"
                                    style="max-height:54px; max-width:88%;">
                            @endif
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        {{-- Approver III → Director --}}
                        <td class="ap-pos">{{ $signatories['approver2']['position'] ?? 'Manager FAT / Head of FAT' }}
                        </td>
                    </tr>
                </table>
            @endif

...
@section('header', 'Form Request List')
                ...
                <div class="flex flex-col gap-3 md:gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 md:gap-3">
                        ...
                        <input type="date" id="request_date" placeholder="YYYY-MM-DD"
                            class="sm:w-40 px-3 py-2 border rounded-lg text-sm">
    ...
    @push('scripts')
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                } else if (status === 'approved manager') {
                                    badgeClass = 'bg-green-500 text-white';
                                } else if (status === 'rejected manager') {
                                    badgeClass = 'bg-red-500 text-white';
                                } else if (status === 'approved finance') {
                                    badgeClass = 'bg-green-500 text-white';
                                } else if (status === 'rejected finance') {
                                    badgeClass = 'bg-red-500 text-white';
                                }
        ...
        `;
                ...
                $('#btnReset').click(function() {
                    $('#request-type-filter').val(null).trigger('change');
                ...
                function renderMobileCards() {
                    ...
                    if (data.length === 0) {
                        container.html(
                            '<div class="text-center py-8" style="color:var(--text-secondary)">No Requests found</div>'
                        );
                        return;
                    }
                    data.each(function(request) {
                        var initials = request.title ?
                            ...
                            <div class="user-card">
                                <div class="user-card-header">
                                    ...
                                    <div class="user-card-title">
                                        <div class="user-card-name">Title : ${request.title || 'N/A'}</div>
                                        <div class="user-card-username">Document Number : ${request.document_number || '-'}</div>
                                    </div>
                                </div>
                                <div class="user-card-body">
                                    <div class="user-card-field">
                                        <div class="user-card-label">User</div>
                                        <div class="user-card-value">${request.user.employee.employee_name || 'N/A'}</div>
                                    </div>
                                    <div class="user-card-field">

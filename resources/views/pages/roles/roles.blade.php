@extends('layouts.app')
@section('title', 'Roles')
@section('header', 'Roles & Permission')
@section('subtitle', 'Manage Roles & Permission')
@section('content')
    <style>
        /* =============================================
        ...
        <div class="vendor-card-container rounded-xl md:rounded-2xl shadow-lg border overflow-hidden">
            ...
            <div class="vendor-card-header px-4 py-4 md:px-6 md:py-5 border-b">
                <div class="flex flex-col gap-3 md:gap-4">
                    <div>
                        <h2 class="vendor-title text-lg md:text-xl font-bold">All Roles</h2>
                        <p class="vendor-subtitle text-xs md:text-sm mt-1">Manage and view all roles system</p>
                    </div>
            ...
            <div class="p-4 md:p-6">
                ...
                <div id="loading-state" class="flex items-center justify-center py-12">
                    <div class="text-center">
                        ...
                        <p class="text-sm">Loading Roles...</p>
                    </div>
                </div>
                            ...
                            <div class="user-card">
                                <div class="user-card-header">
                                    ...
                                    <div class="user-card-title">
                                        <div class="user-card-name">Request Type</div>
                                        </div>
                                </div>
                                <div class="user-card-body">
                                      ...
                                      <div class="user-card-field">
                                        ...
                                        <div class="user-card-value">${requesttype.request_type_name || 'N/A'}</div>
                                    </div>
                                      <div class="user-card-field">
                                        <div class="user-card-label">Code</div>
                                        <div class="user-card-value">${requesttype.code || 'N/A'}</div>
                                    </div>
                                </div>

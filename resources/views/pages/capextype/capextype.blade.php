@extends('layouts.app')
@section('title', 'Capex Type')
@section('header', 'Capex Type List')
        ...
        <div class="vendor-card-container rounded-xl md:rounded-2xl shadow-lg border overflow-hidden">
            ...
            <div class="vendor-card-header px-4 py-4 md:px-6 md:py-5 border-b">
                <div class="flex flex-col gap-3 md:gap-4">
                    <div>
                        <h2 class="vendor-title text-lg md:text-xl font-bold">All Capex Type</h2>
                        <p class="vendor-subtitle text-xs md:text-sm mt-1">Manage and view all system Capex Type</p>
                    </div>
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 md:gap-3">

    {{-- Search Input --}}
    <div class="relative flex-1">
        <input type="text" id="table-search" placeholder="Search Capex Type..."
            ...
            <div class="p-4 md:p-6">
                ...
                <div id="loading-state" class="flex items-center justify-center py-12">
                    <div class="text-center">
                        ...
                        <p class="text-sm">Loading Capex Type...</p>
                    </div>
                </div>
        ...
        <script>
            $(function() {
                var table = $('#users-table').DataTable({
                    ...
                    ajax: "{{ route('capextypes.capextypes') }}",
                    columns: [
                ...
                function renderMobileCards() {
                    ...
                    data.each(function(capextype) {
                        var initials = capextype.code
                            ? capextype.code.substring(0, 2).toUpperCase()
                            : 'VN';
                        var card = `
                            <div class="user-card">
                                <div class="user-card-header">
                                    ...
                                    <div class="user-card-title">
                                        <div class="user-card-name">Capex Type</div>
                                        </div>
                                </div>
                                <div class="user-card-body">

                                      <div class="user-card-field">
                                        <div class="user-card-label">Code</div>
                                        <div class="user-card-value">${capextype.code || 'N/A'}</div>
                                    </div>
                                      <div class="user-card-field">
                                        <div class="user-card-label">Name</div>
                                        <div class="user-card-value">${capextype.employee_name || 'N/A'}</div>
                                    </div>
                                </div>

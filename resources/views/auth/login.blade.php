    ...
    <div class="shell">
        ...
        <div class="left-panel">
            ...
            <div class="left-content">
                <p class="left-desc">
                    A centralized system for managing request forms efficiently — transparent, structured, and
                    real-time.
                </p>
                <div class="feature-row">
                    <span class="feature-dot"></span>
                    <span class="feature-text">Management Form Request</span>
                </div>
                <div class="feature-row">
                    <span class="feature-dot"></span>
        ...
        <div class="right-panel">
            <button class="theme-btn" onclick="toggleTheme()" title="Change Theme">
                <svg class="icon-sun" width="16" height="16" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707M17.657 17.657l-.707-.707M6.343 6.343l-.707-.707M12 8a4 4 0 100 8 4 4 0 000-8z" />
                </svg>
                <svg class="icon-moon" width="16" height="16" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <p class="card-sub">Use HRX account credentials.</p>
                </div>
                ...
                <form action="{{ route('login.post') }}" method="POST" id="loginForm" novalidate>
                    ...
                    <div class="field">
                        ...
                        <div class="field-wrap">
                            ...
                            <input class="field-input {{ $errors->has('username') ? 'is-error' : '' }}" type="text"
                                id="username" name="username" value="{{ old('username') }}" autocomplete="username"
                                placeholder="username HRX" required>
                        </div>
                        @error('username')
                    ...
                    <div class="field">
                        ...
                        <div class="field-wrap">
                            ...
                            <button type="button" class="pw-toggle" onclick="togglePassword()"
                                ...
                                <svg id="eye-closed" style="display:none" width="16" height="16"
                ...
                <p class="card-footer">
                    Doesn't have access?&nbsp; Contact Administrator.
                </p>
            </div>

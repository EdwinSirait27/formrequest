...
<head>
    ...
    <title>429 — Too Many Request · Form Request</title>
...
<div class="shell">
    ...
    <div class="left-panel">
        ...
        <div class="left-content">
            <p class="left-eyebrow">Too Many Request</p>
    ...
    <div class="right-panel">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h2 class="card-title">Too Many Request</h2>
                <p class="card-sub">Plese refresh url then try again. Too Much Permintaan</p>
            </div>
            ...
            <div class="info-block">
                <div class="info-row">
                    ...
                    <div>
                        ...
                        <p class="info-value">Too Many Request</p>

...
<head>
    ...
    <title>500 — Server Error · Form Request</title>
...
<div class="shell">
    ...
    <div class="left-panel">
        ...
        <div class="left-content">
            <p class="left-eyebrow">Server Error</p>
            ...
            <h1 class="left-headline">
                Internal<br>Server<br><em>Error.</em>
            </h1>
            <p class="left-desc">
              The server has encountered an unexpected situation.
Our technical team is monitoring and addressing the situation.
            </p>
        </div>
    ...
    <div class="right-panel">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <p class="card-sub">Your request cannot be processed at this time.</p>
            </div>
            ...
            <div class="info-block">
                <div class="info-row">
                    ...
                    <div>
                        ...
                        <p class="info-value">Internal Server Error</p>
            ...
            <div class="info-block">
                <div class="info-row">
                    ...
                    <div>
                        ...
                        <p class="info-value">Wait a few moments and then try again, or contact your administrator if the problem persists.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="info-block">
                <div class="info-row">
                    ...
                    <div>
                        <p class="info-label">Need Help ASAP?</p>
                                            <p class="info-value">
